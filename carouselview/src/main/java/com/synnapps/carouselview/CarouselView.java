...
public class CarouselView extends FrameLayout {
    ...
    public void setPageTransformInterval(int pageTransformInterval) {
        ...
        containerViewPager.setTransitionVisibility(pageTransformInterval);
    ...
    public void setPageTransformer(@CarouselViewPagerTransformer.Transformer int transformer) {
        setPageTransformer((ViewPager.PageTransformer) new CarouselViewPagerTransformer(transformer));
    ...
    public void setImageClickListener(ImageClickListener imageClickListener) {
        ...
        containerViewPager.setOnClickListener((OnClickListener) imageClickListener);
    }
    ...
    public CarouselViewPager getContainerViewPager() {
        return (CarouselViewPager) containerViewPager;
    }
